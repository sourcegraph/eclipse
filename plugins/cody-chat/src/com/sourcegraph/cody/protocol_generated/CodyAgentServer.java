...
public interface CodyAgentServer {
  ...
  CompletableFuture<CodeActions_ProvideResult> codeActions_provide(CodeActions_ProvideParams params);
  ...
  CompletableFuture<CurrentUserCodySubscription> graphql_getCurrentUserCodySubscription(Void params);
  ...
  CompletableFuture<String> graphql_getRepoIdIfEmbeddingExists(Graphql_GetRepoIdIfEmbeddingExistsParams params);
  ...
  CompletableFuture<Void> webview_receiveMessageStringEncoded(Webview_ReceiveMessageStringEncodedParams params);
  ...
  CompletableFuture<Testing_ClosestPostDataResult> testing_closestPostData(Testing_ClosestPostDataParams params);
  ...
  CompletableFuture<Testing_DiagnosticsResult> testing_diagnostics(Testing_DiagnosticsParams params);
  @JsonRequest("testing/progressCancelation")
  CompletableFuture<Testing_ProgressCancelationResult> testing_progressCancelation(Testing_ProgressCancelationParams params);
  ...
  CompletableFuture<CompletionBookkeepingEvent> testing_autocomplete_completionEvent(CompletionItemParams params);
