    ...
    public static JsonDeserializer<ExtensionMessage> deserializer() {
      return (element, _type, context) -> {
        switch (element.getAsJsonObject().get("type").getAsString()) {
          case "config": return context.deserialize(element, ConfigExtensionMessage.class);
          case "search:config": return context.deserialize(element, Search_configExtensionMessage.class);
          case "history": return context.deserialize(element, HistoryExtensionMessage.class);
          case "transcript": return context.deserialize(element, TranscriptExtensionMessage.class);
          case "view": return context.deserialize(element, ViewExtensionMessage.class);
          case "errors": return context.deserialize(element, ErrorsExtensionMessage.class);
          case "transcript-errors": return context.deserialize(element, Transcript_errorsExtensionMessage.class);
          case "userContextFiles": return context.deserialize(element, UserContextFilesExtensionMessage.class);
          case "clientState": return context.deserialize(element, ClientStateExtensionMessage.class);
          case "clientAction": return context.deserialize(element, ClientActionExtensionMessage.class);
          case "chatModels": return context.deserialize(element, ChatModelsExtensionMessage.class);
          case "update-search-results": return context.deserialize(element, Update_search_resultsExtensionMessage.class);
          case "index-updated": return context.deserialize(element, Index_updatedExtensionMessage.class);
          case "enhanced-context": return context.deserialize(element, Enhanced_contextExtensionMessage.class);
          case "attribution": return context.deserialize(element, AttributionExtensionMessage.class);
          case "setChatEnabledConfigFeature": return context.deserialize(element, SetChatEnabledConfigFeatureExtensionMessage.class);
          case "context/remote-repos": return context.deserialize(element, Context_remote_reposExtensionMessage.class);
          case "setConfigFeatures": return context.deserialize(element, SetConfigFeaturesExtensionMessage.class);
          case "allMentionProvidersMetadata": return context.deserialize(element, AllMentionProvidersMetadataExtensionMessage.class);
...
public final class Transcript_errorsExtensionMessage extends ExtensionMessage {
  ...
  public enum TypeEnum {
    @com.google.gson.annotations.SerializedName("transcript-errors") Transcript_errors,
  }
}
...
public final class ClientStateExtensionMessage extends ExtensionMessage {
  ...
  public enum TypeEnum {
    @com.google.gson.annotations.SerializedName("clientState") ClientState,
  }
}
...
public final class ClientActionExtensionMessage extends ExtensionMessage {
  ...
  public enum TypeEnum {
    @com.google.gson.annotations.SerializedName("clientAction") ClientAction,
  }
}
...
public final class Update_search_resultsExtensionMessage extends ExtensionMessage {
  ...
  public enum TypeEnum {
    @com.google.gson.annotations.SerializedName("update-search-results") Update_search_results,
  }
}
...
public final class Index_updatedExtensionMessage extends ExtensionMessage {
  ...
  public enum TypeEnum {
    @com.google.gson.annotations.SerializedName("index-updated") Index_updated,
  }
}
...
public final class Enhanced_contextExtensionMessage extends ExtensionMessage {
  ...
  public enum TypeEnum {
    @com.google.gson.annotations.SerializedName("enhanced-context") Enhanced_context,
  }
}
...
public final class Context_remote_reposExtensionMessage extends ExtensionMessage {
  ...
  public enum TypeEnum {
    @com.google.gson.annotations.SerializedName("context/remote-repos") Context_remote_repos,
  }
}
...
public final class AllMentionProvidersMetadataExtensionMessage extends ExtensionMessage {
  ...
  public enum TypeEnum {
    @com.google.gson.annotations.SerializedName("allMentionProvidersMetadata") AllMentionProvidersMetadata,
  }
}
}
