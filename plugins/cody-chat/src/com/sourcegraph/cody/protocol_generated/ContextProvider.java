    ...
    public static JsonDeserializer<ContextProvider> deserializer() {
      return (element, _type, context) -> {
        switch (element.getAsJsonObject().get("kind").getAsString()) {
          case "embeddings": return context.deserialize(element, LocalEmbeddingsProvider.class);
          case "search": return context.deserialize(element, LocalSearchProvider.class);
...
public static final class LocalEmbeddingsProvider extends ContextProvider {
  ...
  public enum StateEnum {
    ...
    @com.google.gson.annotations.SerializedName("no-match") No_match,
  ...
  public enum ErrorReasonEnum {
    @com.google.gson.annotations.SerializedName("not-a-git-repo") Not_a_git_repo,
    @com.google.gson.annotations.SerializedName("git-repo-has-no-remote") Git_repo_has_no_remote,
  }
}
